...
Suppose we have a scroll view or a text view, or a table view on a screen. That scroll view stretches all the way to the bottom of the screen. If virtual keyboard appears it is shown over the scroll view content. There is no way for users to see the bottom of the scroll view because is it obscured by the keyboard.
